      ...
      <form className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="outline-none md:py-2.5 border border-gray-500 rounded py-2 px-3"
            required
          />
        </div>
        <div className="flex flex-col gap-1">
        ...
        <div className="flex  items-center justify-between flex-wrap">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              type="number"
              placeholder="0"
              className="outline-none w-28 border border-gray-500 rounded md:py-2.5 px-3 py-2"
            />
          </div>
          <div className="flex md:flex-row flex-col items-center gap-3">
            <p>Course Thumbnail</p>
            <label htmlFor="thumbnailImage"></label>
            <img
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            min={0}
            max={100}
            className="outline-none md:py-2.5 py-2 border border-gray-500 rounded w-28 px-3"
          />
        </div>
        ...
        <div>
          {chapters.map((chapter, chapterIndex) => (
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              <div className="flex justify-between items-center p-4 border-b rounded-b-lg ">
          ...
          <div
            className="flex bg-blue-100 items-center justify-center py-2 rounded-lg cursor-pointer"
