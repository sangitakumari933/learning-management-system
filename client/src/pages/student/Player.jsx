...
const Player = () => {
  ...
  return (
    <>
      <div className="py-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36">
        {/* left column */}
        ...
        <div className="md:mt-10">
          {playerData ? (<div>
            ...
            <div className="flex justify-between items-center mt-1">
              <p>{playerData.chapter}.{playerData.lecture} {playerData.lectureTitle} hi</p>
