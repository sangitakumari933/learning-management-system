  ...
  return courseData ? (
    <>
      <div className="flex flex-col md:flex-row gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div className="absolute top-0 left-0 w-full h-section-height z-0  bg-linear-to-b from-cyan-100/70"></div>
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-details-heading-large text-details-heading-small font-semibold text-gray-800">
        ...
        <div className="max-w-course-card z-10  shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-70">
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            <button className="md:mt-6 mt-4 w-full py-3 bg-blue-600 rounded text-white font-medium">
